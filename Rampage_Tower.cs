...
public class Rampage_Tower : MonoBehaviour, myInterface
{
    string name = "Rampage Tower";
    ...
    private float defaultattackTimer = 2.5f;
    private int kills = 0;

    private int upgradeLevel = 1;
    private int[] upgrade_damage = {60, 70, 80, 90};
    private float[] upgrade_range = {1.05f, 1.20f, 1.35f, 1.5f};
