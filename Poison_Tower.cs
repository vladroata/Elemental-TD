...
public class Poison_Tower : MonoBehaviour, myInterface
{
    string name = "Earth Tower";
    ...
    private int[] upgrade_damage = {40, 50, 60, 75};
    private float[] upgrade_range = {1.15f, 1.3f, 1.45f, 1.6f};
    ...
    public ScriptableBuff poisonDOT;
    ...
    void attack(GameObject target) {
        ...
        //ScriptableBuff buff = Object.Instantiate(poisonDOT);
        target.GetComponent<enemyInterface>().AddBuff(poisonDOT.InitializeBuff(target));
        attackReady = false;
    }
