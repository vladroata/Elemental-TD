...
public class AOE_DMG_Tower : MonoBehaviour, myInterface
{
    string name = "AOE DMG Tower";
    private int damage = 60;
    private int baseDamage;
    private int cost = 190;
    ...
    private int[] upgrade_damage = {70, 80, 90, 100};
    private float[] upgrade_range = {1.35f, 1.45f, 1.55f, 1.7f};
