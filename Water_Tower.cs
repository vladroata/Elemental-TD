...
public class Water_Tower : MonoBehaviour, myInterface
{
    string name = "Water Tower";
    ...
    private int[] upgrade_damage = {60, 75, 90, 110};
    private float[] upgrade_range = {1.5f, 1.6f, 1.6f, 1.7f};
    ...
    public ScriptableBuff slowDebuff;
    ...
    void attack(GameObject target) {
        ...
        target.GetComponent<enemyInterface>().AddBuff(slowDebuff.InitializeBuff(target));
        attackReady = false;
    }
