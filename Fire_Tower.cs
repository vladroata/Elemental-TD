...
public class Fire_Tower : MonoBehaviour, myInterface
{
    string name = "Fire Tower";
    string element = "Fire";
    ...
    private int[] upgrade_damage = {115, 130, 150, 175};
    private float[] upgrade_range = {1.6f, 1.7f, 1.8f, 1.9f};
