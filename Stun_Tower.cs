...
public class Stun_Tower : MonoBehaviour, myInterface
{
    string name = "Stun Tower";
    private int damage = 70;
    private int baseDamage;
    private int cost = 240;
    ...
    private int[] upgrade_damage = {80, 90, 100, 110};
    private float[] upgrade_range = {1.10f, 1.20f, 1.35f, 1.5f};
    ...
    public ScriptableBuff stunDebuff;
    ...
    void attack(GameObject target) {
        ...
        target.GetComponent<enemyInterface>().AddBuff(stunDebuff.InitializeBuff(target));
        attackReady = false;
    }
        ...
        if (overlapCount > 0) {
            ...
            if (prio == 1) { //closest
                ...
                foreach (GameObject enemy in enemies)
                {
                    ...
                    //print("Enemy "+enemy.GetComponent<enemyInterface>().enemyNum+" distance: "+curDistance);
